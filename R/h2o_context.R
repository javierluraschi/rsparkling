...
#' @export
h2o_context <- function(x, strict_version_check = getOption("rsparkling.strict_version_check", TRUE)) {
  UseMethod("h2o_context")
}

#' @export
h2o_context.spark_connection <- function(x, strict_version_check = getOption("rsparkling.strict_version_check", TRUE)) {
...
#' @export
h2o_context.spark_jobj <- function(x, strict_version_check = getOption("rsparkling.strict_version_check", TRUE)) {
...
#' @param strict_version_check (Optional) Setting this to FALSE does not cross check version of H2O and attempts to connect.
#' @export
h2o_flow <- function(sc, strict_version_check = getOption("rsparkling.strict_version_check", TRUE)) {
...
#' @param strict_version_check (Optional) Setting this to FALSE does not cross check version of H2O and attempts to connect.
#' @export
as_h2o_frame <- function(sc, x, name=NULL, strict_version_check=getOption("rsparkling.strict_version_check", TRUE)) {
...
#' @param strict_version_check (Optional) Setting this to FALSE does not cross check version of H2O and attempts to connect.
#' @export
as_spark_dataframe <- function(sc, x, name = paste(deparse(substitute(x)), collapse=""), strict_version_check=getOption("rsparkling.strict_version_check", TRUE)) {
